...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        wait_for_commands: bool = True,  # Whether simulation script should stay alive for IPC/interview commands
        ...
        Args:
            ...
            wait_for_commands: Whether to keep the OASIS environment alive for IPC/interview commands
