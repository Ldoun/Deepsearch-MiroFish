...
def start_simulation():
    ...
    Request (JSON):
        {
            ...
            "wait_for_commands": true,             // Optional: keep simulation process alive for IPC/interview commands
    ...
    try:
        ...
        wait_for_commands = data.get('wait_for_commands', True)  # Optional: keep OASIS env alive after run
