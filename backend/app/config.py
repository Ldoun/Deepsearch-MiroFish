...
class Config:
    ...
    GRAPH_NER_MAX_RETRIES = _env_int('GRAPH_NER_MAX_RETRIES', 0)
    ...
    SIMULATION_LLM_TIMEOUT_SECONDS = _env_float('SIMULATION_LLM_TIMEOUT_SECONDS', LLM_TIMEOUT_SECONDS)
    SIMULATION_LLM_MAX_RETRIES = _env_int('SIMULATION_LLM_MAX_RETRIES', 0)
    SIMULATION_IPC_TIMEOUT_SECONDS = _env_float('SIMULATION_IPC_TIMEOUT_SECONDS', 900.0)
    ...
    WEB_RESEARCH_SUMMARY_SOURCE_LIMIT = _env_int('WEB_RESEARCH_SUMMARY_SOURCE_LIMIT', 24)
    WEB_RESEARCH_SUMMARY_SOURCE_TEXT_CHARS = _env_int('WEB_RESEARCH_SUMMARY_SOURCE_TEXT_CHARS', 4000)
